...
public class AccountController{
            ...
            if (c == null) System.out.println("Cliente não encontrado!");
                ...
                if (!accountExists) {
                    if (accType.equals("2")) {
                        ...
                        if (cAccounts.add(newAccount) && accounts.add(newAccount)) System.out.println("Conta corrente cadastrada com sucesso!"); 
                    } else {
                        SavingsAccount newAccount = new SavingsAccount(c);
                        if (sAccounts.add(newAccount) && accounts.add(newAccount)) System.out.println("Conta poupança cadastrada com sucesso!");
                    }
    ...
    public boolean hasAccounts(String accType, String cpf) {
        if (accType.equals("2")) {
    ...
    public boolean findAccbyNumber(int number) { return accounts.stream().anyMatch(a -> a.getNumber() == number); }
